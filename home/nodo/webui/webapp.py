...
def load_page1_values():
    ...
    page1_networks_tor["route_all_connections_through_tor_switch"]  =   1 # 1: true, 0: false
...
submenu_1 = [
    ...
    dbc.Collapse(
        ...
        ],pills=True,className="d-flex flex-column"
        ),
...
submenu_2 = [
    ...
    dbc.Collapse(
        dbc.Nav(    
        [
            dbc.NavLink(("Private Node").upper(), href="/page-2.1", active="partial"),
...
submenu_4 = [
    ...
    dbc.Collapse(
        ...
        [
            ...
            dbc.NavLink(("Add Account").upper(), href="/page-4.3", active="partial"),
            dbc.NavLink(("Account Creation Requests").upper(), href="/page-4.4", active="partial"),
        ],pills=True,className="d-flex flex-column"
        ),
...
submenu_5 = [
    ...
    dbc.Collapse(
        dbc.Nav(                
        [
            dbc.NavLink(("Transaction Pool").upper(), href="/page-5.1", active="partial"),
            dbc.NavLink(("Transaction Pusher").upper(), href="/page-5.2", active="partial"),
            dbc.NavLink(("Key Images Checker").upper(), href="/page-5.3", active="partial"),
            dbc.NavLink(("Output Keys Checker").upper(), href="/page-5.4", active="partial"),
        ],pills=True,className="d-flex flex-column"
        ),
...
custom_default = dbc.Navbar(
    dbc.Container(
        [
            ...
            dbc.Collapse(
                dbc.Nav(
                    [
                        dbc.NavLink(("Networks").upper(), href="/page-1", class_name="",id="navbar-collapse-navlink-networks", active="partial"),
                        dbc.NavLink(("Node").upper(), href="/page-2", class_name="",id="navbar-collapse-navlink-node", active="partial"),
                        dbc.NavLink(("Device").upper(), href="/page-3", class_name="",id="navbar-collapse-navlink-device", active="partial"),
                        dbc.NavLink(("Monero-LWS").upper(), href="/page-4", class_name="",id="navbar-collapse-navlink-lws-admin", active="partial"),
                        dbc.NavLink(("Block Explorer").upper(), href="/page-5", class_name="",id="navbar-collapse-navlink-block-explorer", active="partial"),
                    ],  className="d-flex align-content-start", navbar=True,pills=True
                ),
    ...
    className="pt-0 pl-0 pr-0 pb-0 ", color="black"
)

sidebar = html.Div(
    [
        dbc.Nav(submenu_1 + submenu_2 + submenu_3 + submenu_4 + submenu_5, vertical=True),
    ],
...
offcanvas =  dbc.Row([
        dbc.Offcanvas(
            dbc.Col([sidebar], width=199), id="offcanvas-placement", title="Settings",close_button=False, is_open=False,placement='end', style={'horizontal-width': 10}, className="d-md-none d-lg-none sidebar"
        ),
    ])
#Sync Status
                ...
                [
                    ...
                    dbc.InputGroup(
                        [
                            ...
                            dbc.Input(type="text",id='page0_sync_status_sync_status',className="homeBoxNodoInput",value=sync_status,disabled=True),
                        ], className="me-1 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Timestamp:",className="homeBoxNodo"),
                            dbc.Input(type="text",id='page0_sync_status_timestamp',className="homeBoxNodoInput",value=timestamp,disabled=True),
                        ], className="me-1 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Current Sync Height:",className="homeBoxNodo"),
                            dbc.Input(type="number",id='page0_sync_status_current_sync_height',className="homeBoxNodoInput",value=current_sync_height,disabled=True),
                        ], className="me-1 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Monero Version:",className="homeBoxNodo"),
                            dbc.Input(type="text",id='page0_sync_status_monero_version',className="homeBoxNodoInput",value=monero_version,disabled=True),
                        ], className="me-1 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Outgoing Connections:",className="homeBoxNodo"),
                            dbc.Input(type="number",id='page0_sync_status_current_outgoing_connections',className="homeBoxNodoInput",value=outgoing_connections,disabled=True),
                        ], className="me-1 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Incoming Connections:",className="homeBoxNodo"),
                            dbc.Input(type="number",id='page0_sync_status_current_incoming_connections',className="homeBoxNodoInput",value=incoming_connections,disabled=True),
                        ], className="me-1 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("White Peerlist Size:",className="homeBoxNodo"),
                            dbc.Input(type="number",id='page0_sync_status_white_peerlist_size',className="homeBoxNodoInput",value=white_peerlist_size,disabled=True),
                        ], className="me-1 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Grey Peerlist Size:",className="homeBoxNodo"),
                            dbc.Input(type="number",id='page0_sync_status_grey_peerlist_size',className="homeBoxNodoInput",value=grey_peerlist_size,disabled=True),
                        ], className="me-1 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Update Available:",className="homeBoxNodo"),
                            dbc.Input(type="text",id='page0_sync_status_update_available',className="homeBoxNodoInput",value=update_available,disabled=True),
                        ], className="me-1 mt-1"
                    ),
        ]
    ),
        ],className="d-flex align-content-start homeCardNodo0", color="black",
        ...
        [
            dbc.CardHeader(
                [
                    ...
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Mainnet Node:",className="homeBoxNodo"),
                            dbc.Input(type="text",id='page0_system_status_mainnet_node',className="homeBoxNodoInput",value=mainnet_node,disabled=True),
                        ], className="me-0 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Private Node:",className="homeBoxNodo"),
                            dbc.Input(type="text",id='page0_system_status_private_node',className="homeBoxNodoInput",value=private_node,disabled=True),
                        ], className="me-0 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Tor Node:",className="homeBoxNodo"),
                            dbc.Input(type="text",id='page0_system_status_tor_node',className="homeBoxNodoInput",value=tor_node,disabled=True),
                        ], className="me-0 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("I2P Node:",className="homeBoxNodo"),
                            dbc.Input(type="text",id='page0_system_status_i2p_node',className="homeBoxNodoInput",value=i2p_node,disabled=True),
                        ], className="me-0 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Monero-LWS-Admin:",className="homeBoxNodo"),
                            dbc.Input(type="text",id='page0_system_status_monero_lws_admin',className="homeBoxNodoInput",value=monero_lws_admin,disabled=True),
                        ], className="me-0 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Block Explorer:",className="homeBoxNodo"),
                            dbc.Input(type="text",id='page0_system_status_block_explorer',className="homeBoxNodoInput",value=block_explorer,disabled=True),
                        ], className="me-0 mt-1"
                    ),
        ],
    ),
        ],className="d-flex align-content-start homeCardNodo1", color="black",
        #id={"type": "card", "index": n_add},
        #style={"min-width": "32vw","max-width": "95vw"},
    )
                ...
                [
                    ...
                    dbc.InputGroup(
                        [
                            ...
                            dbc.Input(type="text",id='page0_hardware_status_cpu_percentage',className="homeBoxNodoInput",value=cpu_percentage,disabled=True),
                        ], className="me-0 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("CPU temp:",className="homeBoxNodo"),
                            dbc.Input(type="text",id='page0_hardware_status_cpu_temp',className="homeBoxNodoInput",value=cpu_temp,disabled=True),
                        ], className="me-0 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Primary Storage:",className="homeBoxNodo"),
                            dbc.Input(type="number",id='page0_hardware_status_primary_storage',className="homeBoxNodoInput",value=primary_storage,disabled=True),
                        ], className="me-0 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("Backup Storage:",className="homeBoxNodo"),
                            dbc.Input(type="number",id='page0_system_status_i2p_node',className="homeBoxNodoInput",value=backup_storage,disabled=True),
                        ], className="me-0 mt-1"
                    ),
                    dbc.InputGroup(
                        [
                            dbc.InputGroupText("RAM:",className="homeBoxNodo"),
                            dbc.Input(type="number",id='page0_system_status_monero_lws_admin',className="homeBoxNodoInput",value=ram_percentage,disabled=True),
                        ], className="me-0 mt-1"
                    ),
        ],
    ),
        ],className="d-flex align-content-start homeCardNodo2", color="black",
        #id={"type": "card", "index": n_add},
        ...
        [
                    ...
                    dbc.Container(
                        [
                            dbc.Collapse(
                                dbc.Nav(
                                    [
                                        dbc.NavLink(("Clearnet").upper(), href="page-1.1" ,className="sencondLevelNavlinkActive"),
                                        dbc.NavLink(("Tor").upper(), href="page-1.2", class_name="sencondLevelNavlink"),
                                        dbc.NavLink(("I2P").upper(), href="page-1.3", class_name="sencondLevelNavlink"),
                                    ], className="d-flex align-content-start bg-black", navbar=True
                                ),
                                className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
            ...
            dbc.InputGroup(
                [
                    ...
                    dbc.Input(id="input-networks-clearnet-address",type="text",value=address),
                ], className="me-1 mt-1"
            ),
            dbc.InputGroup(
                [
                    dbc.InputGroupText("Port"),
                    dbc.Input(id="input-networks-clearnet-port",type="number", min=1024, max=65535, step=1,value=port),
                ], className="me-1 mt-1 pt-2 pb-2",style={"max-width": "150px"}
            ),
            dbc.InputGroup(
                [
                    dbc.InputGroupText("Peer"),
                    dbc.Input(id="input-networks-clearnet-peer",type="text",value=peer),
                ], className="me-1 mt-1 pt-2"
            ),
            dbc.Col(
                dbc.Button(
                    "Add Peer", className="buttonNodo ms-auto fa fa-send ",id="button-networks-clearnet-add-peer", n_clicks=0
                ),
                width="auto", className="me-1 mt-1 pt-2"
            ),
            html.Div(
                html.P("",className="text-center"),style={"width": "95vw"}
            ),
            ...
            html.Div(id="networks-clearnet-add-peer-hidden-div", style={"display":"none"}),
            html.Br(),
            html.Br()
        ]
    )
...
def make_page1_2():
    ...
    route_all_connections_through_tor_switch = bool( page1_networks_tor["route_all_connections_through_tor_switch"] == 1)
    ...
    [
            ...
            dbc.Container(
                [
                    dbc.Collapse(
                        dbc.Nav(
                            [
                                dbc.NavLink(("Clearnet").upper(), href="page-1.1",className="sencondLevelNavlink"),
                                dbc.NavLink(("Tor").upper(), href="page-1.2",className="sencondLevelNavlinkActive" ),
                                dbc.NavLink(("I2P").upper(), href="page-1.3",className="sencondLevelNavlink"),
                            ], className="d-flex align-content-start bg-black", navbar=True
                        ),
                        className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
        ...
        dbc.InputGroup(
            [
                dbc.Label("Route all connections through Tor", className="me-1 mt-1"),
                daq.BooleanSwitch(
        ...
        dbc.InputGroup(
            [
                ...
                dbc.Input(id="input-networks-tor-onion-addr",type="text", disabled=True, value=onion_addr),
            ], className="me-1 mt-1"
        ),
        dbc.Col(
            dbc.Button(
                "Change", className="buttonNodo ms-auto fa fa-send",id="button-networks-tor-change", n_clicks=0
            ),
            width="auto", className="me-1 mt-1 pt-2"
        ),
        dbc.InputGroup(
            [
                dbc.InputGroupText("Port"),
                dbc.Input(id="input-networks-tor-port",type="number", min=1024, max=65535, step=1,value=port),
            ], className="me-1 mt-1 pt-2 pb-2",style={"max-width": "150px"}
        ),
        dbc.InputGroup(
            [
        ...
        dbc.Col(
            dbc.Button(
                "Add Peer", className="buttonNodo ms-auto fa fa-send ",id="button-networks-tor-add-peer", n_clicks=0
            ),
            width="auto", className="me-1 mt-1 pt-2"
        ),
        html.Div(
        ...
        html.Div(id="networks-tor--route-all-connections-through-tor-hidden-div", style={"display":"none"}),
    ...
    [
                ...
                [
                    dbc.Collapse(
                        dbc.Nav(
                            [
                                dbc.NavLink(("Clearnet").upper(), href="page-1.1",className="sencondLevelNavlink"),
                                dbc.NavLink(("Tor").upper(), href="page-1.2",className="sencondLevelNavlink"),
                                dbc.NavLink(("I2P").upper(), href="page-1.3",className="sencondLevelNavlinkActive"),
                            ], className="d-flex align-content-start bg-black", navbar=True
                        ),
                        className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
        ...
        dbc.InputGroup(
            [
                ...
                dbc.Input(type="text", disabled=True,id="input-networks-i2p-i2p-b32-addr", value=i2p_b32_addr),
            ], className="me-1 mt-1"
        ),
        dbc.Col(
            dbc.Button(
                "Change", className="buttonNodo ms-auto fa fa-send",id="button-networks-i2p-change", n_clicks=0
            ),
            width="auto", className="me-1 mt-1 pt-2"
        ),
        dbc.InputGroup(
            [
                dbc.InputGroupText("Port"),
                dbc.Input(type="number", min=1024, max=65535, step=1,id="input-networks-i2p-port",value=port),
            ], className="me-1 mt-1 pt-2 pb-2",style={"max-width": "150px"}
        ),
        dbc.InputGroup(
            [
        ...
        dbc.Col(
            dbc.Button(
                "Add Peer", className="buttonNodo ms-auto fa fa-send ",id="button-networks-i2p-add-peer", n_clicks=0
            ),
            width="auto", className="me-1 mt-1 pt-2"
        ),
        html.Div(
...
def make_page2_1():
    ...
    [
            ...
            dbc.Container(
                [
                    dbc.Collapse(
                        dbc.Nav(
                            [
                                dbc.NavLink(("Private Node").upper(), href="page-2.1",className="sencondLevelNavlinkActive"),
                                dbc.NavLink(("Bandwidth").upper(), href="page-2.2",className="sencondLevelNavlink"),
                            ], className="d-flex align-content-start bg-black", navbar=True
                        ),
                        className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
                        id="navbar-collapse1",
        ...
        dbc.InputGroup(
            [
                dbc.InputGroupText("Port"),
                dbc.Input(type="number", min=1024, max=65535, step=1,id="input-node-rpc-port",value=port),
            ], className="me-1 mt-1",style={"max-width": "150px"}
        ),
        dbc.InputGroup(
            [
                dbc.InputGroupText("Username"),
                dbc.Input(type="text",id="input-node-rpc-username",value=username),
            ], className="me-1 mt-1 pt-2",style={"max-width": "300px"}
        ),
        dbc.InputGroup(
            [
                dbc.InputGroupText("Password"),
                dbc.Input(type="password",id="input-node-rpc-password",value=password),
            ], className="me-1 mt-1 pt-2",style={"max-width": "300px"}
        ),
        dbc.Col(
            dbc.Button(
                    "Apply", className="buttonNodo ms-auto fa fa-send ",id="button-node-rpc-apply", n_clicks=0
            ),
            width="auto", className="me-1 mt-1 pt-2"
        ),
        html.Div(
    ...
    [
                ...
                dbc.Container(
                    [
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink(("Private Node").upper(), href="page-2.1",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Bandwidth").upper(), href="page-2.2",className="sencondLevelNavlinkActive" ),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
                            id="navbar-collapse1",
        ...
        dbc.InputGroup(
            [
                ...
                dbc.Input(type="number", min=-1, max=65535, step=1,id="input-node-bandwidth-incoming-peers-limit",value=incoming_peers_limit),
            ], className="me-1 mt-1"
        ),
        dbc.InputGroup(
            [
                dbc.InputGroupText("Outgoing peers limit"),
                dbc.Input(type="number", min=-1, max=65535, step=1,id="input-node-bandwidth-outgoing-peers-limit",value=outgoing_peers_limit),
            ], className="me-1 mt-1 pt-2"
        ),
        dbc.InputGroup(
            [
                dbc.InputGroupText("Rate-limit up"),
                dbc.Input(type="number", min=-1, max=65535, step=1,id="input-node-bandwidth-rate-limit-up",value=rate_limit_up),
            ], className="me-1 mt-1 pt-2"
        ),
        dbc.InputGroup(
            [
                dbc.InputGroupText("Rate-limit down"),
                dbc.Input(type="number", min=-1, max=65535, step=1,id="input-node-bandwidth-rate-limit-down",value=rate_limit_down),
            ], className="me-1 mt-1 pt-2"
        ),
        html.Div(id="node-bandwidth-hidden-div", style={"display":"none"}),
        html.Div(id="node-bandwidth-incoming-peers-limit-hidden-div", style={"display":"none"}),
        html.Div(id="node-bandwidth-outgoing-peers-limit-hidden-div", style={"display":"none"}),
        html.Div(id="node-bandwidth-rate-limit-up-hidden-div", style={"display":"none"}),
        html.Div(id="node-bandwidth-rate-limit-down-hidden-div", style={"display":"none"}),
        html.Br(),
        html.Br()        
    ]
)
    ...
    [
                ...
                dbc.Container(
                    [
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink(("Wi-Fi").upper(), href="page-3.1",className="sencondLevelNavlinkActive" ),
                                    dbc.NavLink(("Ethernet").upper(), href="page-3.2",className="sencondLevelNavlink"),
                                    dbc.NavLink(("System").upper(), href="page-3.3",className="sencondLevelNavlink"),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
                            id="navbar-collapse1",
        ...
        dbc.InputGroup(
            [
                ...
                dbc.Input(type="password",id="input-device-wifi-passphrase",value=passphrase),
            ], className="me-1 mt-1 pt-2"
        ),
        dbc.InputGroup(
            [
                dbc.InputGroupText("Status"),
                dbc.Input(type="text", disabled=True,id="input-device-wifi-status",value=status),
            ], className="me-1 mt-1 pt-2"
        ),
        html.Br(),
        dbc.InputGroup(
        ...
        dbc.InputGroup(
            [
                ...
                dbc.Input(type="text",id="input-device-wifi-ip-address",className="input-device-wifi-eth",
                          pattern=u"^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}",
                          value=ip_address
                ),
            ], className="me-1 mt-1 pt-2"
        ),
        dbc.InputGroup(
            [
                ...
                dbc.Input(type="text",id="input-device-wifi-subnet-mask",className="input-device-wifi-eth",
                          pattern=u"^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}",
                          value=subnet_mask
                          ),
            ], className="me-1 mt-1 pt-2"
        ...
        dbc.InputGroup(
            [
                ...
                dbc.Input(type="text",id="input-device-wifi-router",className="input-device-wifi-eth",
                          pattern=u"^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}",
                          value=router
                          ),
            ], className="me-1 mt-1 pt-2"
        ...
        dbc.InputGroup(
            [
                ...
                dbc.Input(type="text",id="input-device-wifi-dhcp",className="input-device-wifi-eth",
                          pattern=u"^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}",
                          value=dhcp
                          ),
            ], className="me-1 mt-1 pt-2"
        ...
        html.Div(id="device-wifi-subnet-mask-hidden-div", style={"display":"none"}),
    ...
    [
                ...
                dbc.Container(
                    [
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink(("Wi-Fi").upper(), href="page-3.1",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Ethernet").upper(), href="page-3.2",className="sencondLevelNavlinkActive" ),
                                    dbc.NavLink(("System").upper(), href="page-3.3",className="sencondLevelNavlink"),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
        ...
        dbc.InputGroup(
            [
                dbc.InputGroupText("IP Address"),
                dbc.Input(type="text",
                          id="input-device-ethernet-ip-address",className="input-device-wifi-eth",
                          pattern=u"^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}",
                          value=ip_address
                ),
            ], className="me-1 mt-1"
        ...
        dbc.InputGroup(
            [
                dbc.InputGroupText("Subnet Mask"),
                dbc.Input(type="text",
                          id="input-device-ethernet-subnet-mask",className="input-device-wifi-eth",
                          pattern=u"^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}",
                          value=subnet_mask
                ),
            ], className="me-1 mt-1 pt-2"
        ...
        dbc.InputGroup(
            [
                dbc.InputGroupText("Router"),
                dbc.Input(type="text",
                          id="input-device-ethernet-router",className="input-device-wifi-eth",
                          pattern=u"^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}",
                          value=router
                ),
            ], className="me-1 mt-1 pt-2"
        ...
        dbc.InputGroup(
            [
                dbc.InputGroupText("DHCP"),
                dbc.Input(type="text",
                        id="input-device-ethernet-dhcp",className="input-device-wifi-eth",
                        pattern=u"^[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}",
                        value=dhcp
                ),
            ], className="me-1 mt-1 pt-2"
...
def make_page3_3():
    ...
    [
                        ...
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink(("Wi-Fi").upper(), href="page-3.1",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Ethernet").upper(), href="page-3.2",className="sencondLevelNavlink"),
                                    dbc.NavLink(("System").upper(), href="page-3.3",className="sencondLevelNavlinkActive" ),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
                            id="navbar-collapse1",
        ...
        dbc.Col(
            dbc.Button(
                "Reset", className="me-1 mt-1 ms-auto fa fa-send buttonNodo",id="submit-val-node-system-reset", n_clicks=0
            ),
            width="auto",
        ...
        dbc.Col(
            dbc.Button(
                "Shutdown", className="me-1 mt-1 ms-auto fa fa-send buttonNodo",id="submit-val-node-system-shutdown", n_clicks=0
            ),
            width="auto",
        ),
        dbc.Label(""),
        dbc.Col(
            dbc.Button(
                "Recovery",href="/page-3.3.2", className="me-1 mt-1 ms-auto fa fa-send node-system-recovery-button",id="submit-val-node-system-recovery", n_clicks=0
            ),
            width="auto",
        ),
    ]
...
def make_page3_3_2():
    ...
    [
        ...
        dbc.Label(""),
            dbc.Button(
                "Start", className="me-1 mt-1 node-system-recovery-start-button",id="submit-val-node-system-recovery-start", n_clicks=0
            ),
            dbc.Button(
                "Cancel",href="/page-3.3", className="ml-8 me-1 mt-1 node-system-recovery-cancel-button",id="submit-val-node-system-recovery-cancel", n_clicks=0
            ),
            ...
            dbc.CardHeader(
                [
                        ...
                        [
                            dbc.InputGroup(
                                [
                                    dbc.Row(
                                        [
                                            dbc.Col(dbc.InputGroupText("Address",className="LWSBoxNodo text-left",style={"min-width":"100px","height":"100%","border-radius": "5px 0 0 5px"}),style={"min-width":"100px"},width=1),
                                            dbc.Col(html.Div(address,className="NodoLWSInput",style={"padding-left":"12px","padding-top":"6px","justify-content":"center","height":"100%","min-width":"20%","max-width":"850px","word-break": "break-all","overflow-wrap": "break-word","border-radius": "0 5px 5px 0"}),style={"min-width":"100px","max-width": "850px"}),                            
                            ...
                            dbc.InputGroup(
                                [
                                dbc.InputGroupText("Height",className="LWSBoxNodo text-left",style={"max-width":"110px","height":"100%"}),
                                dbc.Input(type="text", value=height,className="NodoLWSInput", disabled=True,style={"height":"100%"}),
                                ], className="d-flex align-content-start  me-1 mt-1 LWSCardBG",style={"max-width": "200px"}
                            ),
                    ...
                    dbc.InputGroup(
                        ...
                        ], className="me-1 mt-0 mb-2",style={"width": "150px"}
                    ),
                    dbc.Label(""),
                    dbc.Button(
                            "Reactivate", className="buttonNodo me-1 mt-1 ms-auto fa fa-send mt-1 ml-1 mr-1 pt-1 pl-1 pr-1", id={"type": "inactive-reactivate-button", "index": n_add}
                    ),
                    dbc.Button(
                            "Delete", className="buttonNodo me-1 mt-1 ms-auto fa fa-send mt-1 ml-1 mr-1 pt-1 pl-1 pr-1 ", id={"type": "inactive-delete-button", "index": n_add}
                    )
                ]
            ),
        ],
...
def make_inactive_cards():
    ...
    for item in inactive_address_height:
        ...
        account_create_request_lists.append(make_inactive_card(index, address, height, rescan_height));
        index=index+1;
        ...
        [
            dbc.CardHeader(
                [
                    ...
                    dbc.InputGroup(
                        [
                            dbc.Input(type="text", value=rescan_height,id={"type": "active-rescan-input", "index": n_add}),
                        ], className="me-1 mt-0 mb-2 LWSCardBG",style={"width": "150px"}
                    ),
                    dbc.Label(""),
                    dbc.Button(
                            "Rescan", className="buttonNodo me-1 mt-1 ms-auto fa fa-send mt-1 ml-1 mr-1 pt-1 pl-1 pr-1", id={"type": "active-rescan-button", "index": n_add}, disabled=rescan_button_disable
                    ),
                    dbc.Button(
                            "Deactivate", className="buttonNodo me-1 mt-1 ms-auto fa fa-send mt-1 ml-1 mr-1 pt-1 pl-1 pr-1 ", id={"type": "active-deactivate-button", "index": n_add}
                    )
                ]
            ),
        ],
...
def make_active_cards():
    ...
    for item in active_address_height:
        ...
        height=str(item[1]);
        rescan_height=str(item[2]);
        account_create_request_lists.append(make_active_card(index, address,height,rescan_height));
        index=index+1;
                ...
                [
                    ...
                    dbc.InputGroup(
                        [
                            ...
                            dbc.InputGroup(
                                [
                                dbc.InputGroupText("Start Height",className="LWSBoxNodo text-left",style={"max-width":"110px","height":"100%"}),
                                dbc.Input(type="text", value=height,className="NodoLWSInput", disabled=True,style={"height":"100%"}),
                                ], className="d-flex align-content-start  me-1 mt-1 LWSCardBG",style={"max-width": "200px"}
                            ),
                        ], className="d-flex align-content-start LWSCardBG"
                    ...
                    dbc.Button(
                            "Accept", className="buttonNodo me-1 ms-auto fa fa-send mt-2 ml-1 mr-1 pt-1 pl-1 pr-1", id={"type": "request-accept-button", "index": n_add}
                    ),
                    dbc.Button(
                            "Reject", className="buttonNodo me-1 ms-auto fa fa-send mt-2 ml-1 mr-1 pt-1 pl-1 pr-1 ", id={"type": "request-reject-button", "index": n_add}
                    )
                ]
            ),
        ],
...
def make_account_create_request_cards():
    ...
    for item in account_address_viewkey_height:
        ...
        viewkey=str(item[1]);
        height=str(item[2]);
        account_create_request_lists.append(make_account_create_request_card(index, address,height));
        index=index+1;
...
page4_1 = html.Div(
    [
                ...
                dbc.Container(
                    [
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink(("Active").upper(), href="page-4.1" ,className="sencondLevelNavlinkActive" ),
                                    dbc.NavLink(("Inactive").upper(), href="page-4.2" ,className="sencondLevelNavlink"),
                                    dbc.NavLink(("Add Account").upper(), href="page-4.3" ,className="sencondLevelNavlink"),
                                    dbc.NavLink(("Account Creation Requests").upper(), href="page-4.4", className="sencondLevelNavlink")
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
                            id="navbar-collapse1",
        ...
        html.Div(id='active_card_components',),
        html.Div(id='container-button-basic4_1a',children=''),
        html.Div(id='container-button-basic4_1b',children=''),
        html.Div(id="active-card-input-rescan-height-hidden-div", style={"display":"none"}),
    ]
)
...
page4_2 = html.Div(
    [
                ...
                dbc.Container(
                    [
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink(("Active").upper(), href="page-4.1" ,className="sencondLevelNavlink"),
                                    dbc.NavLink(("Inactive").upper(), href="page-4.2", className="sencondLevelNavlinkActive"),
                                    dbc.NavLink(("Add Account").upper(), href="page-4.3" ,className="sencondLevelNavlink"),
                                    dbc.NavLink(("Account Creation Requests").upper(), href="page-4.4" ,className="sencondLevelNavlink"),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
        ...
        html.Div(id='inactive_card_components',),
...
page4_3 = html.Div(
    [
                        ...
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink(("Active").upper(), href="page-4.1" ,className="sencondLevelNavlink"),
                                    dbc.NavLink(("Inactive").upper(), href="page-4.2" ,className="sencondLevelNavlink"),
                                    dbc.NavLink(("Add Account").upper(), href="page-4.3" ,className="sencondLevelNavlinkActive" ),
                                    dbc.NavLink(("Account Creation Requests").upper(), href="page-4.4" ,className="sencondLevelNavlink"),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
        ...
        dbc.Col(
            dbc.Button(
                "Add Account", className="buttonNodo ms-auto fa fa-send ",id="button-lwsadmin-add-account", n_clicks=0
            ),
            width="auto", className="me-1 mt-1",
        ...
        html.Div(id="lwsadmin-add-account-address-hidden-div", style={"display":"none"}),
    ]
)
...
page4_4 = html.Div(
    [
                        ...
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    ...
                                    dbc.NavLink(("Inactive").upper(), href="page-4.2" ,className="sencondLevelNavlink"),
                                    dbc.NavLink(("Add Account").upper(), href="page-4.3" ,className="sencondLevelNavlink"),
                                    dbc.NavLink(("Account Creation Requests").upper(), href="page-4.4" ,className="sencondLevelNavlinkActive" ),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
                            id="navbar-collapse1",
        ...
        dbc.Col(
            dbc.Button(
                "Accept All Requests", className="buttonNodo ms-auto fa fa-send ",id="button-lwsadmin-account-creation-requests", n_clicks=0
            ),
            width="auto", className="me-1 mt-1 mb-1"
        ),
        html.Div(
            html.P("",className="text-center"),style={"width": "95vw"}
        ),
        html.Div(id='lwsadmin-account-creation-requests-hidden-div', style={"display":"none"}),
        html.Div(id="lwsadmin-account-creation-requests-request-accept-button-hidden-div", style={"display":"none"}),
        html.Div(id="lwsadmin-account-creation-requests-request-reject-button-hidden-div", style={"display":"none"}),
       	html.Div(id='request_card_components',
             )
...
def make_page5_1():
    ...
    transactionInTheLastBlock = pd.DataFrame({
        'height':['[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)',
                '[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)','[2902010](block2902010)'],
        'age [h:m:s]': ['00:05:13', '00:05:13', '00:05:13','00:05:13', '00:05:13', '00:05:13','00:05:13', '00:05:13', '00:05:13','00:05:13', '00:05:13', '00:05:13',
                '00:05:13', '00:05:13', '00:05:13','00:05:13', '00:05:13', '00:05:13','00:05:13', '00:05:13', '00:05:13','00:05:13', '00:05:13', '00:05:13'],
        'size [kB]': ['34.45', '34.45', '34.45','34.45', '34.45', '34.45','34.45', '34.45', '34.45','34.45', '34.45', '34.45','34.45', '34.45', '34.45','34.45', '34.45', '34.45','34.45', '34.45', '34.45','34.45', '34.45', '34.45'],
        'transaction hash': ['[8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667](/tx8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667)', '[f2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb](/txf2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb)', '[709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691](/tx709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691)','[8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667](/tx8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667)', '[f2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb](/txf2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb)', '[709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691](/tx709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691)','[8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667](/tx8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667)', '[f2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb](/txf2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb)', '[709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691](/tx709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691)','[8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667](/tx8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667)', '[f2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb](/txf2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb)', '[709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691](/tx709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691)',
                '[8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667](/tx8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667)', '[f2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb](/txf2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb)', '[709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691](/tx709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691)','[8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667](/tx8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667)', '[f2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb](/txf2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb)', '[709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691](/tx709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691)','[8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667](/tx8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667)', '[f2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb](/txf2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb)', '[709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691](/tx709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691)','[8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667](/tx8ecec2abff451e7ff0eff2e8e2278d080d9808f17182fbded0da81fc9bdd6667)', '[f2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb](/txf2d5fd936429b2c54ad47cf5ac508580767e92fac210861295cd8139c41c5ccb)', '[709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691](/tx709817acf581b6feae569a5239a80093e6547d339c261ecab406a63a2ee2e691)'],    
        'fee [µɱ]': ['N/A', '0044', '0122','N/A', '0044', '0122','N/A', '0044', '0122','N/A', '0044', '0122','N/A', '0044', '0122','N/A', '0044', '0122','N/A', '0044', '0122','N/A', '0044', '0122'],
        'outputs': ['0.602', '?', '?','0.602', '?', '?','0.602', '?', '?','0.602', '?', '?','0.602', '?', '?','0.602', '?', '?','0.602', '?', '?','0.602', '?', '?'],
        'in/out': ['0/36', '2/2', '1/2','0/36', '2/2', '1/2','0/36', '2/2', '1/2','0/36', '2/2', '1/2','0/36', '2/2', '1/2','0/36', '2/2', '1/2','0/36', '2/2', '1/2','0/36', '2/2', '1/2'],
        'tx size [kB]': ['1.46', '2.16', '1.50','1.46', '2.16', '1.50','1.46', '2.16', '1.50','1.46', '2.16', '1.50','1.46', '2.16', '1.50','1.46', '2.16', '1.50','1.46', '2.16', '1.50','1.46', '2.16', '1.50'],
    }
    )
    ...
    for ind in outputs_DataFrame.index:
        ...
        height = "[" + str(outputs_DataFrame['height'][ind]) + "](block" + str(outputs_DataFrame['height'][ind]) + ")";
        ...
        for indexTXS in outputs_txs_DataFrame.index:
            tx_hash = "[" + str(outputs_txs_DataFrame['tx_hash'][indexTXS]) + "](tx" + str(outputs_txs_DataFrame['tx_hash'][indexTXS]) + ")";
            ...
            xmr_outputs = str(round(outputs_txs_DataFrame['xmr_outputs'][indexTXS]/1000000000000,3));
            transactionInTheLastBlock.loc[-1] = [height, age, size, tx_hash,tx_fee,xmr_outputs,in_out,tx_size]  # adding a row
            transactionInTheLastBlock.index = transactionInTheLastBlock.index + 1  # shifting index
    ...
    [
                ...
                dbc.Container(
                    [
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink(("Transaction Pool").upper(), href="page-5.1",className="sencondLevelNavlinkActive" ) ,
                                    dbc.NavLink(("Transaction Pusher").upper(), href="page-5.2",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Key Images Checker").upper(), href="page-5.3",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Output Keys Checker").upper(), href="page-5.4",className="sencondLevelNavlink"),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
                            id="navbar-collapse1",
        ...
        dbc.InputGroup(
        [
            dbc.Input(type="text", placeholder="block height,block hash, transaction hash", className="d-flex align-content-start boxNodo"),
            dbc.Button([search_icon, ""],id="transcation-pool-hash-search", n_clicks=0, color="black", className="d-flex align-content-start  border border-whilte" ),
        ],className="mt-1 mb-1"
        ),
        html.P("Server time: " + transaction_pool_infomation["server_time"] + 
               " | Network difficulty: " + transaction_pool_infomation["network_difficulty"] + 
               " | Hard fork: " + transaction_pool_infomation["hard_fork"] + 
               " | Hash rate: " + transaction_pool_infomation["hash_rate"] + 
               " | Fee per byte: " + transaction_pool_infomation["fee_per_byte"] + 
               " | Median block size limit: " + transaction_pool_infomation["median_block_size_limit"] + " ",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Monero emission (fees) is " + transaction_pool_infomation["monero_emission"] + 
                "(" + transaction_pool_infomation["monero_emission_fees"] + 
                ") as of " + transaction_pool_infomation["monero_emission_fees_as_of_block"] + " block",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Transaction Pool",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("(no of txs: " + transaction_pool_infomation["no_of_txs"] + ", size: " + transaction_pool_infomation["size_of_txs"] + ", updated every 5 seconds)",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P(
                dash_table.DataTable(
                data=transactionPoolDF.to_dict(orient='records'),
                columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'transaction hash' else {'id': x, 'name': x} for x in transactionPoolDF.columns],
                style_header={
                ...
                page_size=1000,
                style_cell= { 'textAlign': 'center' , 'backgroundColor': 'black', 'margin-top': '0', 'margin-bottom': '0'},
                style_table={'overflowX': 'auto', 'top': '0vh', 'left': '0vw', 'width': '95vw','bottom': '5vh','background-color' : 'black','marginLeft': 'auto', 'marginRight': 'auto'},
                style_cell_conditional=[
                    {'if': {'column_id': 'age [h:m:s]'},
                            'width': '21%','min-width':"225px"},
                    {'if': {'column_id': 'transaction hash'},
                            'width': '63%'},
                    {'if': {'column_id': 'fee/per_kB [µɱ]'},
                            'width': '8%'},                    
                    {'if': {'column_id': 'in/out'},
                            'width': '4%'},
                    {'if': {'column_id': 'tx size [kB]'},
                            'width': '4%'},                              
                ],
        ...
        html.Div(
        [
            html.P("Transactions in the last 11 blocks",className="text-center"),
            html.P("(Median size of 100 blocks: 292.97 kB)",className="text-center"),
        ]
        ),
        html.P(
                dash_table.DataTable(
                data=transactionInTheLastBlock.to_dict(orient='records'),
                columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'transaction hash' or x == "height" else {'id': x, 'name': x} for x in transactionInTheLastBlock.columns],
                style_header={
                        'backgroundColor': 'black',
                        'color':'white',
                        'border': '1px solid #202020'
                ...
                fixed_rows={'headers': True},
                page_size=1000,
                style_cell= { 'textAlign': 'center' , 'backgroundColor': 'black', 'margin-bottom': '0'},
                style_table={ 'overflow': 'auto','top': '0vh', 'left': '0vw', 'width': '95vw','max-height':'30vh','bottom': '5vh','background-color' : 'black','marginLeft': 'auto', 'marginRight': 'auto'},
...
tab_page5_1_tx_decode_outputs = html.Div(
    [
        html.P("Check which outputs belong to given Monero address/subaddress and viewkey",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("For RingCT transactions, outputs' amounts are also decoded",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Note: address/subaddress and viewkey are sent to the server, as the calculations are done on the server side",className="text-center",style={"overflow-wrap": "break-word"}),
        dbc.InputGroup(
            [
                dbc.Input(type="text", placeholder="Monero address/subaddress",id="input-page5_1_tx_monero_address_subaddress"),
            ], className="me-1 mt-1"
        ),
        dbc.InputGroup(
            [
                dbc.Input(type="text", placeholder="Private viewkey",id="input-page5_1_tx_viewkey"),
            ], className="me-1 mt-1"
        ),
        dbc.Container(
            dbc.Row(
            [
                ...
                [
                    dbc.Button(
                        "Decode outputs", href="/page-5.1-tx-decode-outputs", className="d-flex justify-content-end text-center buttonNodo ml-8 me-1 mt-1 ",id="submit-val-page5_1_decode_outputs", n_clicks=0, style={'textAlign':'center'}
                    ),                                   
...
tab_page5_1_tx_prove_sending = html.Div(
    [
        html.P("Prove to someone that you have sent them Monero in this transaction",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Tx private key can be obtained using get_tx_key command in monero-wallet-cli command line tool",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Note: address/subaddress and tx private key are sent to the server, as the calculations are done on the server side",className="text-center",style={"overflow-wrap": "break-word"}),
        dbc.InputGroup(
            [
                dbc.Input(type="text", placeholder="Tx private key",id="input-page5_1_tx_tx_private_key"),
            ], className="me-1 mt-1"
        ),
        dbc.InputGroup(
            [
                dbc.Input(type="text", placeholder="Recipient's monero address/subaddress",id="input-page5_1_tx_recipients_monero_address_subaddress"),
            ], className="me-1 mt-1"
        ),
        dbc.Container(
            dbc.Row(
            [
                ...
                [
                    dbc.Button(
                        "Prove sending", className="d-flex justify-content-end text-center buttonNodo ml-8 me-1 mt-1 ",id="submit-val-page5_1_prove_sending", n_clicks=0, style={'textAlign':'center'}
                    ),                                   
                ],  className="d-flex justify-content-center ",
                    width=2,
                )
...
def make_page_5_1_and_5_2_tx_inputs_of_total_xmrs(tx):
    ...
    key_image_DataFrame = pd.DataFrame({
        'col0':["key image 00: 3f6e7190d088c0f61554d554c6318ee99518c30a1e81082f570ff086d0ae9167"],
#        'col1': ["amount: ?"],
        }
    )
    key_image_ring_members_DataFrame = pd.DataFrame({
        ...
        'blk': ["02306487","02435894","02442403","02445287","02446488","02447662","02447969","02447992","02448269","02448306","02448306","02306487","02435894","02442403","02445287","02446488","02447662","02447969","02447992","02448269","02448306","02448306","02306487","02435894","02442403","02445287","02446488","02447662","02447969","02447992","02448269"],
        'ring size':["11","11","11","11","11","11","11","11","0","11","11","11","11","11","11","11","11","11","11","0","11","11","11","11","11","11","11","11","11","11","0"],
        'in/out': ["1/2","2/2","2/5","1/2","2/2","2/2","1/2","2/2","0/1","1/2","1/2","1/2","2/2","2/5","1/2","2/2","2/2","1/2","2/2","0/1","1/2","1/2","1/2","2/2","2/5","1/2","2/2","2/2","1/2","2/2","0/1"],
        'timestamp':["2021-02-28 04:21:18","2021-08-26 23:19:37","2021-09-04 23:42:21","2021-09-08 23:57:27","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-08-26 23:19:37","2021-09-04 23:42:21","2021-09-08 23:57:27","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-08-26 23:19:37","2021-09-04 23:42:21","2021-09-08 23:57:27","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18"],
        'age [y:d:h:m:s]': ["02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49"],
        }
    )
    ...
    return html.Div(
        [
            html.P(str(transaction_pool_tx_inputs_of_total_xmrs["num_of_xmrs"]) + " input(s) for total of ? xmr",className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
            html.P(
                    dash_table.DataTable(
                    data=key_image_DataFrame.to_dict(orient='records'),
                    columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'col0' or x == "height" else {'id': x, 'name': x} for x in key_image_DataFrame.columns],
                    ...
                    style_cell= { 'textAlign': 'left' , 'backgroundColor': 'black', 'margin-bottom': '0'},
                    style_table={'overflowX': 'auto','top': '0vh', 'left': '0vw', 'width': '95vw','bottom': '0vh','background-color' : 'black','marginLeft': 'auto', 'marginRight': 'auto'},
            ...
            html.P(
                    ...
                    columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'ring members' or x == "height" else {'id': x, 'name': x} for x in key_image_ring_members_DataFrame.columns],
                    style_header={
                            'backgroundColor': 'black',
                            'color':'white',
                            'border': '1px solid #202020'
...
def make_page_5_1_tx_decode_or_prove_outputs_output(param1, param2, prove):
    ...
    outputs_DataFrame = outputs_DataFrame.reindex(columns=['output_pubkey', 'amount', 'match'])
    outputs_DataFrame.rename(columns={'output_pubkey': 'output public key', 'match': 'output match?'}, inplace=True)
    ...
    tx_decode_or_prove_outputs_output["tx_public_key"]  = "4463830f3d76317d8e3ef6a922c8ff9c480520b49b60144d6f88f2440c978ace" 
    ...
    key_image_DataFrame = pd.DataFrame({
        ...
        'col1':["Timestamp [UTC]: " + tx_decode_or_prove_outputs_output["timestamp_utc"]], 
    ...
    key_image_ring_members_DataFrame = pd.DataFrame({
        ...
        'blk': ["02306487","02435894","02442403","02445287","02446488","02447662","02447969","02447992","02448269","02448306","02448306"],
        'ring size':["11","11","11","11","11","11","11","11","0","11","11",],
        'in/out': ["1/2","2/2","2/5","1/2","2/2","2/2","1/2","2/2","0/1","1/2","1/2",],
        'timestamp':["2021-02-28 04:21:18","2021-08-26 23:19:37","2021-09-04 23:42:21","2021-09-08 23:57:27","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18","2021-02-28 04:21:18",],
        'age [y:d:h:m:s]': ["02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49","02:103:22:58:49",],
        }
    )
    return html.Div(
        [
            html.P("Tx hash: " + tx_decode_or_prove_outputs_output["tx_hash"] ,className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
            html.P("Tx public key: " + tx_decode_or_prove_outputs_output["tx_public_key"] ,className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
            html.P("Paymentid (decrypted): " + tx_decode_or_prove_outputs_output["paymentid"] + "(value incorrect if you are not the recipient of the tx)" ,className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
            html.P(
                    dash_table.DataTable(
                    data=key_image_DataFrame.to_dict(orient='records'),
                    columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'col0' or x == "height" else {'id': x, 'name': x} for x in key_image_DataFrame.columns],
            ...
            html.Br(),
            html.Br(),
            html.P(description ,className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
            html.Br(),                        
            html.P("address: " + tx_decode_or_prove_outputs_output["address"] ,className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
            html.P("private key: " + tx_decode_or_prove_outputs_output["viewkey"] ,className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
            html.P("Outputs(" + str(num_of_xmrs) + ")",className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
            html.Br(),
            html.Br(),
            html.P(
                    dash_table.DataTable(
                    data=outputs_DataFrame.to_dict(orient='records'),
                    columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'ring members' or x == "height" else {'id': x, 'name': x} for x in outputs_DataFrame.columns],
                    style_header={
                            'backgroundColor': 'black',
                            'color':'white',
                            'border': '1px solid #202020'
                ...
                dbc.Container(
                    [
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink("Transaction Pool", href="page-5.1",className="sencondLevelNavlinkActive" ) ,
                                    dbc.NavLink("Transaction Pusher", href="page-5.2",className="sencondLevelNavlink"),
                                    dbc.NavLink("Key Images Checker", href="page-5.3",className="sencondLevelNavlink"),
                                    dbc.NavLink("Output Keys Checker", href="page-5.4",className="sencondLevelNavlink"),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
                            id="navbar-collapse1",
...
def make_page_5_1_tx(tx):
    transaction_pool_tx = {};
    transaction_pool_tx["txPrefixHash"] = "f16f681796ef2aa4cae46acf502d03f52d6843de00a4b0d8b2144c26e09ce2e6";
    transaction_pool_tx["txPublicKey"] = "4463830f3d76317d8e3ef6a922c8ff9c480520b49b60144d6f88f2440c978ace";
    transaction_pool_tx["txPaymentId"] = "1c4d48af4a071950"

    transaction_pool_tx["txTable1_timestamp"] = "Timestamp: 1666425153";
    transaction_pool_tx["txTable1_timestamp_utc"] = "Timestamp [UTC]: 2022-10-22 07:52:33";
    ...
    txTable1_DataFrame = pd.DataFrame({
        'col0':[transaction_pool_tx["txTable1_timestamp"],transaction_pool_tx["txTable1_block"],transaction_pool_tx["txTable1_tx_version"]],
        'col1': [transaction_pool_tx["txTable1_timestamp_utc"],transaction_pool_tx["txTable1_fee_per_kB"],transaction_pool_tx["txTable1_no_of_confirmations"]],
        'col2': [transaction_pool_tx["txTable1_age"], transaction_pool_tx["txTable1_tx_size"], transaction_pool_tx["txTable1_ringct_type"]],
        }
    )
    transaction_pool_tx["txExtra"] = "01d1041b3ab9294e944c1c1b1a5d3424e2af8810fae0a1160bd51aa597203f60ae0209018ecf9de6d87a19f9"

    txTable2_DataFrame = pd.DataFrame({
        'stealth':["00:","01:"],
        'address': ["21e4b7d27dcdf46c7bfec7219ac8c6e82eaa8e586cf63d9f07467fec0be7d7e7","21e4b7d27dcdf46c7bfec7219ac8c6e82eaa8e586cf63d9f07467fec0be7d7e7"],
        'amount': ["?", "?"],
    ...
    [
        ...
        dbc.InputGroup(
        [
            dbc.Input(type="text", placeholder="block height,block hash, transaction hash", className="d-flex align-content-start"),
            dbc.Button([search_icon, ""],id="transcation-publisher-hash-search", n_clicks=0, color="black", className="d-flex align-content-start  border border-whilte" ),
        ],className="mt-1 mb-1 mr-10"
        ),
        html.P(""),
        html.P("Tx Hash: " + tx, className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        html.P("Tx prefix Hash: " + transaction_pool_tx["txPrefixHash"], className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        html.P("Tx public Key: " + transaction_pool_tx["txPublicKey"], className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        html.P("Payment id (encrypted): " + transaction_pool_tx["txPaymentId"], className="text-center mb-0 pb-0",style={'width': '95vw',"line-break": "anywhere"}),
        html.P(
                dash_table.DataTable(
                data=txTable1_DataFrame.to_dict(orient='records'),
                columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'col0' or x == "height" else {'id': x, 'name': x} for x in txTable1_DataFrame.columns],
                style_header = {'display': 'none'},
                style_data={
                        'backgroundColor': 'black',
                        'color':'white',
        ...
        #html.Br(),
        #html.Br(),
        html.P("Extra: " + transaction_pool_tx["txExtra"], className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        html.P(transaction_pool_tx["outputs_of_total_xmr"] + " Output(s) of total ? xmr", className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        
        html.P(
                dash_table.DataTable(
                data=txTable2_DataFrame.to_dict(orient='records'),
                columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'col0' or x == "height" else {'id': x, 'name': x} for x in txTable2_DataFrame.columns],
                style_header={
                        'backgroundColor': 'black',
                        'color':'white',
                        'border': '1px solid #202020'
                ...
                page_size=1000,
                style_cell= { 'textAlign': 'center' , 'backgroundColor': 'black', 'margin-bottom': '0'},
                style_table={ 'overflowX': 'auto', 'top': '5vh', 'left': '0vw', 'width': '95vw','bottom': '5vh','background-color' : 'black','marginLeft': 'auto', 'marginRight': 'auto'},
                css=[dict(selector= "p", rule= "margin: 0; text-align: center")],
                markdown_options={"link_target": "_self"},
                cell_selectable=False
            ), className="d-flex align-content-start mb-10"
        ...
        html.Br(),
            dbc.Tabs(
            [
                dbc.Tab(tab_page5_1_tx_decode_outputs, label="Decode outputs", label_style=tab_style,  active_label_style=tab_selected_style),
                dbc.Tab(tab_page5_1_tx_prove_sending, label="Prove Sending", label_style=tab_style,  active_label_style=tab_selected_style),
            ], style=tabs_styles),
...
def make_page5_block_status(block):
    ...
    block_status["pow_hash"] = "cfae919165dd44891954037d3927a118e3efce72f1c8d17b44d35a0100000000";
    ...
    return html.Div(
                        ...
                        [
                            html.Tbody(
                                [
                                    html.Tr(
                                        [
                                            html.Td('Timestamp [UTC] (epoch): ' + block_status["timestampUTC"], style={'color':'white','border-left': '1px solid #202020','border-right': '1px solid #000000','border-top': '1px solid #202020'}),
                                            html.Td('Age [y:d:h:m:s]: ' + block_status["age"], style={'color':'white','text-align': 'left','border-right': '1px solid #000000','border-top': '1px solid #202020'},),
                                            html.Td('Δ [h:m:s]: ' + block_status["delta"], style={'color':'white','border-right': '1px solid #202020','border-top': '1px solid #202020'}),
                                        ]
                                    ),
                                    html.Tr(
                                        [
                                            html.Td('Major.minor version: ' + block_status["major_minor_version"], style={'color':'white','border-left': '1px solid #202020','border-right': '1px solid #000000'}),                                
                                            html.Td('Block reward: '+ block_status["block_reward"], style={'color':'white','text-align': 'left','border-right': '1px solid #000000'}),
                                            html.Td('Block size [kB]: '+ block_status["block_size"], style={'color':'white','border-right': '1px solid #202020'}),
                                        ]
                                    ),
                                    html.Tr(
                                        [
                                            html.Td('nonce: '+ block_status["nonce"], style={'color':'white','border-left': '1px solid #202020','border-right': '1px solid #000000'}),
                                            html.Td('Total fees: '+ block_status["total_fees"], style={'color':'white','text-align': 'left','border-right': '1px solid #000000'}),
                                            html.Td('No of txs: '+ block_status["no_of_txs"], style={'color':'white','border-right': '1px solid #202020'})
                                        ]
                                    ),
                                    html.Tr(
                                        [
                                            html.Td('PoW hash: '+ block_status["pow_hash"], colSpan=2, style={'color':'white','border-left': '1px solid #202020','border-right': '1px solid #000000'}),
                                            html.Td('Difficulty: '+ block_status["difficulty"], style={'color':'white','border-right': '1px solid #202020'})
                                        ]
                                    )                        
                                ]
                            )
                ...
                ),style={"overflow-x": "auto","margin-right": "auto","margin-left": "auto",'width': '95vw'}                       
            )
...
def make_page_5_1_block_transaction_numbers(block):
    ...
    block_transaction_infomation["hash"]="c7e17c513d8f8fe7e271ce5343a903fd531e7214c1d706f8543a2851e1744320";
    ...
    miner_reward_transaction_DataFrame = pd.DataFrame({
            'hash': ["[" +block_transaction_infomation["hash"] +"](tx" + block_transaction_infomation["hash"] + ")"
            ],
    ...
    block_transaction_numbers_DataFrame = pd.DataFrame({
        ...
        'outputs': ["?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?","?"],
        'fee [µɱ]':["0210","0044","0011","0011","0011","0011","0011","0011","0011","0011","0011","0210","0044","0011","0011","0011","0011","0011","0011","0011","0011","0011","0210","0044","0011","0011","0011","0011","0011","0011","0011","0011","0011"],
        'in/out': ["1/2","2/2","2/5","1/2","2/2","2/2","1/2","2/2","0/1","1/2","1/2","1/2","2/2","2/5","1/2","2/2","2/2","1/2","2/2","0/1","1/2","1/2","1/2","2/2","2/5","1/2","2/2","2/2","1/2","2/2","0/1","1/2","1/2"],
        'size [kB]':["1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209","1.4209"],
        'version': ["2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2","2"],
        }
    )
    ...
    return html.Div(
        [
            html.P("Miner reward transaction",className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
            html.P(
                    dash_table.DataTable(
                    data=miner_reward_transaction_DataFrame.to_dict(orient='records'),
                    columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'hash' or x == "height" else {'id': x, 'name': x} for x in miner_reward_transaction_DataFrame.columns],
                    style_header={
                            'backgroundColor': 'black',
                            'color':'white',
                            'border': '1px solid #202020'
            ...
            html.P("Transactions" + "(" + str(block_transaction_infomation["num_of_transactions"]) + ")",className="text-center",style={'width': '95vw',"line-break": "anywhere"}),

            html.P(
                    dash_table.DataTable(
                    data=block_transaction_numbers_DataFrame.to_dict(orient='records'),
                    columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'hash' or x == "height" else {'id': x, 'name': x} for x in block_transaction_numbers_DataFrame.columns],
                    style_header={
                            'backgroundColor': 'black',
                            'color':'white',
                            'border': '1px solid #202020'
...
def make_page_5_1_block(block):
    block_dictionary={};
    block_dictionary["blockHash"] = "945d8cbf3db17b01633f99490886befc8d09d8e4f508545d7bf889f51aa8e7c7";
    block_dictionary["previous_block"] = "a12aab4f0b7ec8d75d8d0e8c350862a3f3411e24c8ccb5a91e44ecbacae366ae";
    block_dictionary["next_block"] = "0e19d20bfe45f4a9317e7665e2be4149ffe9bc49796342ebeae0527c388fc444";
    ...
    [
        ...
        html.P("Block hash (height): " + block_dictionary["blockHash"] + "("+ block_dictionary["blockHeight"] + ")", className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        html.P(
            [
                "Previous block: ",
                html.A("" + block_dictionary["previous_block"], href = "block" + block_dictionary["previous_block"]),
                ""
            ], className="text-center",style={'width': '95vw',"line-break": "anywhere"}
        ),
        html.P(
            [
                "Next block: ",
                html.A("" + block_dictionary["next_block"], href = "block" + block_dictionary["next_block"]),
                ""
            ], className="text-center",style={'width': '95vw',"line-break": "anywhere"}
        ),
...
def make_page_5_2_tx_check(param1):
    tx_check={};
    tx_check["txHash"] = "f16f681796ef2aa4cae46acf502d03f52d6843de00a4b0d8b2144c26e09ce2e6"
    tx_check["txPrefixHash"] = "f16f681796ef2aa4cae46acf502d03f52d6843de00a4b0d8b2144c26e09ce2e6";
    tx_check["txPublicKey"] = "4463830f3d76317d8e3ef6a922c8ff9c480520b49b60144d6f88f2440c978ace";
    ...
    txTable1_DataFrame = pd.DataFrame({
        'col0':[tx_check["txTable1_timestamp"],tx_check["txTable1_block"],tx_check["txTable1_tx_version"]],
        'col1': [tx_check["txTable1_timestamp_utc"],tx_check["txTable1_fee_per_kB"],tx_check["txTable1_no_of_confirmations"]],
        'col2': [tx_check["txTable1_age"], tx_check["txTable1_tx_size"], tx_check["txTable1_ringct_type"]],
        }
    )
    tx_check["txExtra"] = "01d1041b3ab9294e944c1c1b1a5d3424e2af8810fae0a1160bd51aa597203f60ae0209018ecf9de6d87a19f9"
    ...
    [
                ...
                dbc.Container(
                    [
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink(("Transaction Pool").upper(), href="page-5.1",className="sencondLevelNavlink" ) ,
                                    dbc.NavLink(("Transaction Pusher").upper(), href="page-5.2",className="sencondLevelNavlinkActive"),
                                    dbc.NavLink(("Key Images Checker").upper(), href="page-5.3",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Output Keys Checker").upper(), href="page-5.4",className="sencondLevelNavlink"),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
        ...
        html.P("Tx Hash: " + tx_check["txHash"], className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        html.P("Tx prefix Hash: " + tx_check["txPrefixHash"], className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        html.P("Tx public Key: " + tx_check["txPublicKey"], className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        html.P("Payment id (encrypted): " + tx_check["txPaymentId"], className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        html.P(
                dash_table.DataTable(
                data=txTable1_DataFrame.to_dict(orient='records'),
                columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'col0' or x == "height" else {'id': x, 'name': x} for x in txTable1_DataFrame.columns],
        ...
        html.Br(),
        html.Br(),
        html.P("Extra: " + tx_check["txExtra"], className="text-center",style={'width': '95vw',"line-break": "anywhere"}),
        html.P(
                dash_table.DataTable(
                data=txTable2_DataFrame.to_dict(orient='records'),
                columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'col0' or x == "height" else {'id': x, 'name': x} for x in txTable2_DataFrame.columns],
...
def make_page_5_2_tx_push(param1):
    tx_push={};
    tx_push["txHash"] = "f16f681796ef2aa4cae46acf502d03f52d6843de00a4b0d8b2144c26e09ce2e6";
    tx_push["txPublicKey"] = "4463830f3d76317d8e3ef6a922c8ff9c480520b49b60144d6f88f2440c978ace";
    ...
    [
        ...
        html.Div(
            html.P("Transaction Pusher",className="text-center"),style={"width": "95vw"}
        ),
        html.P("Attempting to push tx:" + tx_push["txHash"],className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Success",className="text-center",style={"overflow-wrap": "break-word","color":"green"}),
        html.P("Your tx should aready in the txpool waiting to be included in an upcoming block.",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Go to tx: " + tx_push["txHash"],className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("source code | explorer version (api): master-2023-03-28-d669720(1.2)",className="text-center",style={"overflow-wrap": "break-word"}),
    ]
    )
...
page5_2 = html.Div(
    [
        ...
        html.P("Paste here either a hex string or raw transaction",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("(the tx_blob response in the wallet RPC, or the raw_monero_tx file saved by the wallet CLI with --do-not-relay option specified), or base64 encoded, unsigned or signed transaction data.",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("(In Linux, can get the raw tx data: cat raw_monero_tx | xclip -selection clipboard)",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("(In Windows, can get the raw tx data: certuntil.exe -encode -f raw_monero_tx_encoded.ext & type \"encoded.txt\" | clip)",className="text-center",style={"overflow-wrap": "break-word"}),
        dcc.Textarea(
            id='textarea_explorer_transaction_pusher',
            value='', className="boxNodo",
            style={'width': '100%', 'height': 300},
        ),
        html.P("Note: data is sent to the server, as the calculations are done on the server side",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Note: \"check\" does not work for the hex string of raw transaction",className="text-center",style={"overflow-wrap": "break-word"}),
        dbc.Container(
            dbc.Row(
            [
                dbc.Col(
                [
                    dbc.Button(
                        "Check", href="/page-5.2-tx-check", className="d-flex justify-content-end text-center buttonNodo me-1 mt-1 ",id="submit-val_explorer_transaction_pusher_check", n_clicks=0, style={'textAlign':'center'}
                    ),
                    dbc.Button(
                        "Push", href="/page-5.2-tx-push", className="d-flex justify-content-end text-center buttonNodo ml-8 me-1 mt-1 ",id="submit-val_explorer_transaction_pusher_push", n_clicks=0, style={'textAlign':'center'}
                    ),                    
                ],  className="d-flex justify-content-center ",
                    width=2,
                )
...
def page5_3_key_images_checker_check(param1,param2):
    ...
    key_images_checker_check["data_prefix"]="d8a53d51a8fc167fac8268214ef50165214dcf3abd30dbb2340f3f990398c42a"
    key_images_checker_check["address"]="21e4b7d27dcdf46c7bfec7219ac8c6e82eaa8e586cf63d9f07467fec0be7d7e7"
    key_images_checker_check["viewkey"]="4463830f3d76317d8e3ef6a922c8ff9c480520b49b60144d6f88f2440c978ace"
    key_images_DataFrame = pd.DataFrame({
        'Key no.':["00:","01:"],
        'Key image': ["21e4b7d27dcdf46c7bfec7219ac8c6e82eaa8e586cf63d9f07467fec0be7d7e7","21e4b7d27dcdf46c7bfec7219ac8c6e82eaa8e586cf63d9f07467fec0be7d7e7"],
        'Is spent?': [True, False],
        }
    )
    ...
    [
                        ...
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    dbc.NavLink(("Transaction Pool").upper(), href="page-5.1",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Transaction Pusher").upper(), href="page-5.2",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Key Images Checker").upper(), href="page-5.3",className="sencondLevelNavlinkActive"),
                                    dbc.NavLink(("Output Keys Checker").upper(), href="page-5.4",className="sencondLevelNavlink"),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
        ...
        [
            dbc.Input(type="text", placeholder="block height,block hash, transaction hash", className="d-flex align-content-start boxNodo"),
            dbc.Button([search_icon, ""],id="key-images-checker-search", n_clicks=0, color="black", className="d-flex align-content-start  border border-whilte" ),
        ],className="mt-1 mb-1"
        ),
        html.Div(
            html.P("Signed Key Images Checker",className="text-center"),style={"width": "95vw"}
        ), 
        html.P("Data file prefix: " + key_images_checker_check["data_prefix"] ,className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Key images for address: " + key_images_checker_check["address"] ,className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Viewkey: " + key_images_checker_check["viewkey"] ,className="text-center",style={"overflow-wrap": "break-word"}),      
        html.P(
                dash_table.DataTable(
                data=key_images_DataFrame.to_dict(orient='records'),
                columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'col0' or x == "height" else {'id': x, 'name': x} for x in key_images_DataFrame.columns],
                style_header={
                            'backgroundColor': 'black',
                            'color':'white',
                            'border': '1px solid #202020'
...
page5_3 = html.Div(
    [
        ...
        html.P("Paste base64 encoded, signed key images data here",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("(In Linux, can get base64 signed raw tx data: based64 your_key_images_file | xclip -selection clipboard)",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("(In Windows, can get base64 signed raw tx data: certuntil.exe -encode -f your_key_images_file_encoded.txt & type \"encoded.txt\" | clip)",className="text-center",style={"overflow-wrap": "break-word"}),
        dcc.Textarea(
            id='textarea_explorer_transaction_key_images_checker',
            value='', className="boxNodo",
            style={'width': '100%', 'height': 300},
        ),
        html.P("Viewkey (key image file is encoded using your viewkey. This is needed for descryption)",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Note: data and viewkey are sent to the server, as the calculations are done on the server side.",className="text-center",style={"overflow-wrap": "break-word"}),
        dbc.InputGroup(
                        [
                            dbc.Input(type="text",id='input_explorer_transaction_key_images_checker', className="boxNodo"),
                        ], className="me-1 mt-1"
        ),
        dbc.Container(
            dbc.Row(
            [
                ...
                [
                    dbc.Button(
                        "Check", href="/page-5-3-key-images-checker-check",className="d-flex justify-content-end text-center buttonNodo me-1 mt-1 ",id="submit-val_explorer_transaction_key_images_checker_check", n_clicks=0, style={'textAlign':'center'}
                    ),               
                ],  className="d-flex justify-content-center ",
                    width=2,
                )
...
def page5_4_signed_output_public_keys_checker_check(param1,param2):
    ...
    signed_output_public_keys_checker_check["data_prefix"]="d8a53d51a8fc167fac8268214ef50165214dcf3abd30dbb2340f3f990398c42a"
    signed_output_public_keys_checker_check["address"]="21e4b7d27dcdf46c7bfec7219ac8c6e82eaa8e586cf63d9f07467fec0be7d7e7"
    signed_output_public_keys_checker_check["viewkey"]="4463830f3d76317d8e3ef6a922c8ff9c480520b49b60144d6f88f2440c978ace"
    signed_output_public_keys_checker_check["total_xmr"]=2
    output_public_key_DataFrame = pd.DataFrame({
        'Output no.':["00:","01:"],
        'Public key': ["21e4b7d27dcdf46c7bfec7219ac8c6e82eaa8e586cf63d9f07467fec0be7d7e7","21e4b7d27dcdf46c7bfec7219ac8c6e82eaa8e586cf63d9f07467fec0be7d7e7"],
    ...
    [
                        ...
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    ...
                                    dbc.NavLink(("Transaction Pusher").upper(), href="page-5.2",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Key Images Checker").upper(), href="page-5.3",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Output Keys Checker").upper(), href="page-5.4",className="sencondLevelNavlinkActive"),
                                ], className="d-flex align-content-start bg-black", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
                            id="navbar-collapse1",
        ...
        html.Div(
            html.P("Signed Outputs Public Keys Checker",className="text-center"),style={"width": "95vw"}
        ), 
        html.P("Data file prefix: " + signed_output_public_keys_checker_check["data_prefix"] ,className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Key images for address: " + signed_output_public_keys_checker_check["address"] ,className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("Viewkey: " + signed_output_public_keys_checker_check["viewkey"] ,className="text-center",style={"overflow-wrap": "break-word"}),  
        html.P("Total xmr: " + str(signed_output_public_keys_checker_check["total_xmr"]) ,className="text-center",style={"overflow-wrap": "break-word"}),              
        
        html.P(
                dash_table.DataTable(
                data=output_public_key_DataFrame.to_dict(orient='records'),
                columns=[{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'col0' or x == "height" else {'id': x, 'name': x} for x in output_public_key_DataFrame.columns],
                style_header={
                            'backgroundColor': 'black',
                            'color':'white',
                            'border': '1px solid #202020'
...
page5_4 = html.Div(
    [
                        ...
                        dbc.Collapse(
                            dbc.Nav(
                                [
                                    ...
                                    dbc.NavLink(("Key Images Checker").upper(), href="page-5.3",className="sencondLevelNavlink"),
                                    dbc.NavLink(("Output Keys Checker").upper(), href="page-5.4" ,className="sencondLevelNavlinkActive"),
                                ], className="d-flex align-content-start", navbar=True
                            ),
                            className="d-sm-none d-md-none pt-0 pl-0 pr-0 pb-0",
                            id="navbar-collapse1",
                            navbar=True
        ...
        [
            dbc.Input(type="text", placeholder="block height,block hash, transaction hash", className="d-flex align-content-start boxNodo"),
            dbc.Button([search_icon, ""],id="output-keys-checker-search", n_clicks=0, color="black", className="d-flex align-content-start  border border-whilte" ),
        ],className="mt-1 mb-1"
        ),
        html.Div(
            html.P("Signed Output Public Keys Checker",className="text-center"),style={"width": "95vw"}
        ),
        html.P("Paste base64 encoded, signed key images data here",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("(In Linux, can get base64 signed raw tx data: based64 your_key_images_file | xclip -selection clipboard)",className="text-center",style={"overflow-wrap": "break-word"}),
        html.P("(In Windows, can get base64 signed raw tx data: certuntil.exe -encode -f your_key_images_file_encoded.txt & type \"encoded.txt\" | clip)",className="text-center",style={"overflow-wrap": "break-word"}),
        ...
        dbc.InputGroup(
                        [
                            dbc.Input(type="text",id='input_explorer_transaction_output_keys_checker', className="boxNodo"),
                        ], className="me-1 mt-1"
        ),
        dbc.Container(
            dbc.Row(
            [
                ...
                [
                    dbc.Button(
                        "Check", href="/page-5-4-signed-output-public-keys-checker-check", className="d-flex justify-content-end text-center buttonNodo me-1 mt-1 ",id="submit-val_explorer_transaction_output_keys_checker_check", n_clicks=0, style={'textAlign':'center'}
                    ),            
                ],  className="d-flex justify-content-center ",
                    width=2,
                )
...
app.layout = html.Div([dcc.Location(id="url"), custom_default, content, offcanvas,
dcc.Interval(
...
@app.callback(
    ...
    Input("input-networks-clearnet-port", "value"),prevent_initial_call=True)
...
@app.callback(
    ...
    Input("input-networks-clearnet-peer", "value"),prevent_initial_call=True)
...
@app.callback(
    ...
    [State("input-networks-clearnet-port", "value"),State("input-networks-clearnet-peer", "value")],
...
def update_switch_networks_clearnet_add_peer(n_clicks,port,peer):
    ...
    if not ctx.triggered:
        raise PreventUpdate
    print("(Button) callback by button-networks-clearnet-add-peer Port : " + str(port) + ", Peer " + str(peer));
...
@app.callback(
    ...
    Input("switch-networks-tor", "on"),prevent_initial_call=True)
...
@app.callback(
    ...
    Input("switch-networks-tor-route-all-connections-through-tor-switch", "on"),prevent_initial_call=True)
def update_switch_networks_clearnet(value):
    global page1_networks_tor
    ctx = dash.callback_context
    ...
    if not ctx.triggered:
        raise PreventUpdate
    print("(Switch) callback by switch-networks-tor-route-all-connections-through-tor-switch : " + str(value));
    if value == True:
...
@app.callback(
    ...
    Input("input-networks-tor-port", "value"),prevent_initial_call=True)
...
@app.callback(
    ...
    Input("input-networks-tor-peer", "value"),prevent_initial_call=True)
...
@app.callback(
    ...
    [State("input-networks-tor-port", "value"),State("input-networks-tor-peer", "value")],
    prevent_initial_call=True)
def update_switch_networks_tor_add_peer(n_clicks,port,peer):
    ...
    if not ctx.triggered:
        raise PreventUpdate
    print("(Button) callback by button-networks-tor-add-peer Port : " + str(port) + ", Peer " + str(peer));
...
@app.callback(
    ...
    Input("switch-networks-i2p", "on"),prevent_initial_call=True)
...
@app.callback(
    ...
    Input("input-networks-i2p-port", "value"),prevent_initial_call=True)
...
@app.callback(
    ...
    Input("input-networks-i2p-peer", "value"),prevent_initial_call=True)
...
@app.callback(
    ...
    [State("input-networks-i2p-port", "value"),State("input-networks-i2p-peer", "value")],
    prevent_initial_call=True)
def update_switch_networks_i2p_add_peer(n_clicks,port,peer):
    ...
    if not ctx.triggered:
        raise PreventUpdate
    print("(Button) callback by button-networks-i2p-add-peer Port : " + str(port) + ", Peer " + str(peer));
...
@app.callback(
    ...
    Input("switch-node-rpc", "on"),prevent_initial_call=True)
...
def update_node_rpc_apply(n_clicks,port,username,password):
    ...
    if not ctx.triggered:
        raise PreventUpdate
    print("(Button) callback by button-node-rpc-apply Port: " + str(port) + ", Username " + str(username) + ", Password " + str(password) );
...
@app.callback(
    ...
    Input("input-node-bandwidth-incoming-peers-limit", "value"),prevent_initial_call=True)
def update_input_node_bandwidth_incoming_peers_limit(value):
    ...
    if not ctx.triggered:
        raise PreventUpdate
    print("(Input) callback by input-node-bandwidth-incoming-peers-limit : " + str(value));
...
@app.callback(
    ...
    Input("input-node-bandwidth-outgoing-peers-limit", "value"),prevent_initial_call=True)
def update_input_node_bandwidth_outgoing_peers_limit(value):
    ...
    if not ctx.triggered:
        raise PreventUpdate
    print("(Input) callback by input-node-bandwidth-outgoing-peers-limit : " + str(value));
...
@app.callback(
    ...
    Input("input-node-bandwidth-rate-limit-up", "value"),prevent_initial_call=True)
...
@app.callback(
    ...
    Input("input-node-bandwidth-rate-limit-down", "value"),prevent_initial_call=True)
...
@app.callback(
    ...
    Input("switch-device-wifi", "on"),prevent_initial_call=True)
...
@app.callback(
    ...
    Input("input-device-wifi-ssid", "value"),prevent_initial_call=True)
...
@app.callback(
    ...
    Input("input-device-wifi-passphrase", "value"),prevent_initial_call=True)
def update_input_node_rpc_port(value):
    global page3_device_wifi
    ctx = dash.callback_context
...
def update_input_device_ethernet_ip_address_by_switches_input_device_ethernet_automatic(value):
    global page3_device_ethernet
...
#====================================================================
@app.callback(Output('active_card_components', 'children'),
...
def update_active_card_components(n):
    ...
    print("The active_address_height pair list is :", active_address_height)
    print("The account_address_viewkey_height pair list is :", account_address_viewkey_height)
...
#====================================================================
@app.callback(Output('inactive_card_components', 'children'),
              [Input('interval-component', 'n_intervals')])
def update_active_card_components(n):
    global inactive_address_height
    global account_address_viewkey_height
...
def update_add_account(n_clicks, addressValue, privateViewkeyValue):
    ...
    if addressValue!=None and privateViewkeyValue!=None:
        ...
        if matchObj:
            ...
            # ...
            #========================================================
            account_address_viewkey_height.append((addressValue, privateViewkeyValue,start_height));
        else:
            print ("Address must be started with 4.")
    print ("++++")
    print("The pair list is :", account_address_viewkey_height)
...
#====================================================================
@app.callback(Output('request_card_components', 'children'),
              [Input('interval-component', 'n_intervals')])
...
#====================================================================
@app.callback(
    Output("lwsadmin-account-creation-requests-request-accept-button-hidden-div", "children"),
    [
...
#====================================================================
@app.callback(
    Output("lwsadmin-account-creation-requests-request-reject-button-hidden-div", "children"),
    [
...
def update_button_decode_outputs_href(tx_tx_private_key, tx_recipients_monero_address_subaddress):
    print ("update_button_decode_outputs_href")
    print ("tx_tx_private_key", tx_tx_private_key);
    print ("tx_recipients_monero_address_subaddress", tx_recipients_monero_address_subaddress);
    print ("tx_tx_private_key", tx_tx_private_key!=None);
    print ("tx_recipients_monero_address_subaddress", tx_recipients_monero_address_subaddress!=None);
    if tx_tx_private_key!=None and tx_recipients_monero_address_subaddress!=None:
        if len(tx_tx_private_key)>0 and len(tx_recipients_monero_address_subaddress)>0:
...
def update_button_explorer_transaction_pusher_check_href(textarea_explorer_transaction_pusher):
    ...
    print ("textarea_explorer_transaction_pusher", textarea_explorer_transaction_pusher!=None);
...
def update_button_explorer_transaction_key_images_checker_check_href(textarea_explorer_transaction_key_images_checker, input_explorer_transaction_key_images_checker):
    print ("update href of submit-val_explorer_transaction_pusher_check")
    print ("textarea_explorer_transaction_key_images_checker", textarea_explorer_transaction_key_images_checker);
    print ("textarea_explorer_transaction_key_images_checker", textarea_explorer_transaction_key_images_checker!=None);
    print ("input_explorer_transaction_key_images_checker", input_explorer_transaction_key_images_checker);
    print ("input_explorer_transaction_key_images_checker", input_explorer_transaction_key_images_checker!=None);
    if textarea_explorer_transaction_key_images_checker!=None and input_explorer_transaction_key_images_checker!=None:
        if len(textarea_explorer_transaction_key_images_checker)>0 and len(input_explorer_transaction_key_images_checker)>0:
...
def update_button_explorer_transaction_output_keys_checker_href(textarea_explorer_transaction_output_keys_checker, input_explorer_transaction_output_keys_checker):
    print ("update href of submit-val_explorer_transaction_output_keys_checker_check")
    print ("textarea_explorer_transaction_output_keys_checker", textarea_explorer_transaction_output_keys_checker);
    print ("textarea_explorer_transaction_output_keys_checker", textarea_explorer_transaction_output_keys_checker!=None);
    print ("input_explorer_transaction_output_keys_checker", input_explorer_transaction_output_keys_checker);
    print ("input_explorer_transaction_output_keys_checker", input_explorer_transaction_output_keys_checker!=None);
    if textarea_explorer_transaction_output_keys_checker!=None and input_explorer_transaction_output_keys_checker!=None:
        if len(textarea_explorer_transaction_output_keys_checker)>0 and len(input_explorer_transaction_output_keys_checker)>0:
